<div class="form-kedua" id="form-kedua">
    <div class="form-group">
        ...
        <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukkan alamat rumah..."></textarea>
    </div>
    <div class="form-group">
        <label>Poli Klinik</label>
        <select id="poli" class="form-control" name="poli">
    ...
    <div class="form-group">
        ...
        <input type="date" id="tglPeriksa" name="tglPeriksa" class="form-control" placeholder="Masukkan tanggal periksa...">
