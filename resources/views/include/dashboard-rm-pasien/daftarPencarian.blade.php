@if($count_rm < 1)
    <h1 class="text-center" style="margin:5rem 0 5rem 0"><b>Data rekam medis tidak tersedia!</b></h1>
@else
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $g->tgl_periksa }}</td>
                <td>
                    <a href="/dashboard/pasien/cari/rm/cetak/{{ $g->id_rm }}" class="btn btn-default aksi" id="{{ $g->id_rm }}">
