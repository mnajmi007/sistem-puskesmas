                    ...
                    <div class="data-profil" id="data-profil">
                        ...
                        <div class="tempat-tinggal" id="tempat-tinggal" style="display:none">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="alamat-pasien" placeholder="Masukkan alamat rumah..."></textarea>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label>RT</label>
                                        <input type="number" class="form-control rt-pasien" id="rt-pasien" placeholder="RT...">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>RW</label>
                                        <input type="number" class="form-control rw-pasien" id="rw-pasien" placeholder="RW...">
                                    </div>
                                </div>
                            </div>
                            <div class="button">
