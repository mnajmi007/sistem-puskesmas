<div class="modal fade menu-aksi" id="menu-aksi{{ $pasien->no_rm }}">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">

                <div class="btn-modal">
                    <button class="btn close-modal close-aksi" id="{{ $pasien->no_rm }}">
                ...
                <div class="pilihan">
                    <div class="pilihan-aksi text-center">
                        <a href="#" class="edit-pasien" id="{{ $pasien->no_rm }}">Edit profil pasien</a>
                    </div>
                    <div class="pilihan-aksi text-center">
